...
Feature: Deduction for wrong answers
  ...
  @javascript
  Scenario: Test deduction and overriding of deduction by admin for Moodle ≤ 4.2
  ...
  @javascript
  Scenario: Test deduction and overriding of deduction by admin for Moodle ≥ 4.3 and Moodle ≤ 4.4
