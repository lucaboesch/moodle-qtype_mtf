...
Feature: Step 2
  ...
  #Export question
    When I am on the "Course 1" "core_question > course question export" page logged in as "admin"
  ...
  Scenario: Testcase 25 for Moodle ≤ 4.2
  ...
  @javascript @_file_upload @qtype_mtf_scenario25
  Scenario: Testcase 25 for Moodle ≥ 4.3 and Moodle ≤ 4.4
    Given the site is running Moodle version 4.3 or higher
    And the site is running Moodle version 4.4 or lower

  # Import question
    When I am on the "Course 1" "core_question > course question import" page logged in as "admin"
    And I set the field "id_format_xml" to "1"
    And I upload "question/type/mtf/tests/fixtures/testquestion.moodle.xml" file to "Import" filemanager
    And I press "id_submitbutton"
    Then I should see "Parsing questions from import file."
