...
if (!$all && (!($courseid > 0 || $categoryid > 0))) {
    echo "<br /><center><h1><br />********** Multichoice (with Multi Answers Only) migration to qtype_mtf (Multichoice ETHz). **********<br /><br /><font color='red'>You should specify either the '<font color='black'>courseid</font>'
